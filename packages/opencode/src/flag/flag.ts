...
export namespace Flag {
  ...
  export declare const OPENCODE_WEB_UI_ORIGIN: string | undefined
...
Object.defineProperty(Flag, "OPENCODE_WEB_UI_ORIGIN", {
  get() {
    return process.env["OPENCODE_WEB_UI_ORIGIN"]
  },
  enumerable: true,
  configurable: false,
})
