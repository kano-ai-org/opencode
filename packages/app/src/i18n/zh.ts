...
export const dict = {
  ...
  "settings.general.row.modelConfigPreset.title": "模型配置预设",
  "settings.general.row.modelConfigPreset.description": "无需重启服务器即可切换当前的 oh-my-openagent 模型组合",
  "settings.general.row.modelConfigPreset.toast.applied.title": "已切换模型配置",
  "settings.general.row.modelConfigPreset.toast.applied.description": "当前使用 {{preset}}",
