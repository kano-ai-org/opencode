...
export const dict = {
  ...
  "session.activity.title": "Session activity",
  "session.activity.working": "Working",
  "session.activity.retrying": "Retrying",
  "session.activity.waiting": "Waiting on {{count}} sub-agents",
  "session.activity.idle": "Idle",
  "session.activity.lastActivity": "Last activity {{time}}",
  "session.activity.parent": "Parent session",
  "session.activity.activeSubagents": "{{count}} active sub-agents",
  "session.activity.activeShort": "{{count}} active",
  "session.activity.openSubagent": "Open sub-agent session: {{name}}",
  "session.activity.retryAttempt": "Retrying (attempt {{attempt}})",
  ...
  "settings.servers.section.workspaceSync": "Workspace sync",
  "settings.servers.workspaceSync.title": "Start workspace sync",
  "settings.servers.workspaceSync.description": "Start sync loops for active sessions in the current project.",
  "settings.servers.workspaceSync.button": "Sync workspaces",
  "settings.servers.workspaceSync.button.busy": "Syncing...",
  "settings.servers.workspaceSync.toast.started.title": "Workspace sync started",
  "settings.servers.workspaceSync.toast.started.description": "Active project sessions are syncing in the background.",
