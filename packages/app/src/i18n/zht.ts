...
export const dict = {
  ...
  "session.activity.title": "工作階段活動",
  "session.activity.working": "執行中",
  "session.activity.retrying": "重試中",
  "session.activity.waiting": "等待 {{count}} 個子代理程式",
  "session.activity.idle": "閒置",
  "session.activity.lastActivity": "最後活動於 {{time}}",
  "session.activity.parent": "父工作階段",
  "session.activity.activeSubagents": "{{count}} 個活躍子代理程式",
  "session.activity.activeShort": "{{count}} 個執行中",
  "session.activity.openSubagent": "開啟子代理程式工作階段: {{name}}",
  "session.activity.retryAttempt": "重試中 (第 {{attempt}} 次)",
  ...
  "settings.general.row.modelConfigPreset.title": "模型設定預設",
  "settings.general.row.modelConfigPreset.description": "不用重啟伺服器即可切換目前的 oh-my-openagent 模型組合",
  "settings.general.row.modelConfigPreset.toast.applied.title": "已切換模型設定",
  "settings.general.row.modelConfigPreset.toast.applied.description": "目前使用 {{preset}}",
